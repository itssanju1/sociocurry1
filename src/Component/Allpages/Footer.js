   ...
   <div className='container-fluid  h-100' style={{backgroundColor:'rgb(54, 54, 54)'}}>
    <div className='row'>
      ...
      <div className='col-xl-4 col-xs-8 col-sm-8 mb-5 '>
       ...
       <img src={footerpic} className='m-5 w-25' alt='hello' ></img>
       </div>
       <div className='classfootercol1'>
      ...
      <div className='col-xl-4 col-lg-4 col-xs-8 col-sm-8 col-md-6 mt-5 mb-5'>
        

<div className='row'>
  <div className='col classnamecss'>
  <div className=''>
<h3 className=' ' style={{color:'rgb(255, 110, 20)'}}>SOCIOCURRY SUPORT</h3>
</div>
  <div className=''>
<h5 className=' ' style={{color:'white'}}>Available 7 days a week </h5></div>
  <div className=''>
  
  <button className='btn mt-5 w-75 fs-4' style={{backgroundColor:'white'}}><EmailIcon style={{width:'2.5rem',height:'2.5rem'}}/> sociocurry@gmail.com</button>
  </div>
  
  <div className=' '>
    <button className='btn mt-3 w-75 fs-4' style={{ textAlign:'left',backgroundColor:'white'}}><CallIcon style={{width:'2.5rem',height:'2.5rem'}}/> +91 9818777620</button>
    </div>
     <div className=' '>
  <button className='btn mt-3 w-75 fs-4' style={{ textAlign:'left',backgroundColor:'white'}}><MapsUgcSharpIcon style={{width:'2.5rem',height:'2.5rem'}}/> Chat with Us</button>
  </div>
  <div className=''>
    <h3 className='mt-5 'style={{color:'rgb(255, 110, 20)'}} >CONNECT WITH US</h3>
    </div>
  </div>
</div>
    ...
    <div className='classnamecss'>
     <Instagram  style={{color:'white' ,width:'3.5rem',height:'3.5rem'}}/>
